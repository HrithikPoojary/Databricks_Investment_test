...
This folder defines all source code for the '03_Pipelines_Update' pipeline:
...
* Take a look at the sample under "sample_users_03_pipelines_update.py" to get familiar with the syntax.
